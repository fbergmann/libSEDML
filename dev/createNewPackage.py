...
def createSedML():
  ...
  m1 = dict({'name': 'Model', 'typecode': 'SEDML_MODEL', 'isListOf': True})
  c1 = dict({'name': 'Change', 'typecode': 'SEDML_CHANGE', 'isListOf': True})
  ...
  s1 = dict({'name': 'Simulation', 'typecode': 'SEDML_SIMULATION', 'isListOf' : True})
  ...
  t1 = dict({'name': 'Task', 'typecode': 'SEDML_TASK', 'isListOf' : True})
  d1 = dict({'name': 'DataGenerator', 'typecode': 'SEDML_DATAGENERATOR', 'isListOf' : True})
  o1 = dict({'name': 'Output', 'typecode': 'SEDML_OUTPUT', 'isListOf' : True})
