...
def writeGetFunctions(fileOut, pkg):
  ...
  fileOut.write('\t */\n')
  fileOut.write('\tvirtual SEDMLNamespaces* getSEDMLExtensionNamespaces(const std::string &uri) const;\n\n\n')
  fileOut.write('\t/**\n')
...
def writeTypeDefns(fileOut, nameOfClass, nameOfPkg, elements, number):
  ...
  fileOut.write('//\n')
  fileOut.write('// {0}PkgNamespaces is derived from the SEDMLNamespaces class and\n'.format(nameOfPkg))
